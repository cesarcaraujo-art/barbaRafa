...
// COLE SUA CHAVE DO RESEND ABAIXO (Substitua o 're_123456789' pela sua chave)
...
app.post('/api/enviar-email-confirmacao', async (req, res) => {
  ...
  try {
    const dataEnvio = await resend.emails.send({
      from: 'Barbearia Estilo & Corte <onboarding@resend.dev>', // E-mail de envio padrão do Resend
      to: email,
