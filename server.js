...
// Rota de Health Check / Ping para o Render
app.get('/api/ping', (req, res) => {
  res.status(200).send('OK');
});

// Configuração do Nodemailer para a porta 465 (SSL)
const transporter = nodemailer.createTransport({
  host: 'smtp.gmail.com',
  port: 465,
  secure: true, // Conexão SSL na porta 465
  auth: {
...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    ...
    pass: 'zitm dnvs taqk qrta' // Pega a Senha de App configurada nas variáveis do Render
  },
  tls: {
...
// Configuração da porta com suporte ao bind da rede do Render ('0.0.0.0')
const PORT = process.env.PORT || 3000;
app.listen(PORT, '0.0.0.0', () => {
  console.log(`🚀 Servidor rodando com sucesso na porta ${PORT}`);
}); // Pega a Senha de App configurada nas variáveis do Render
  },
  tls: {
    rejectUnauthorized: false
  },
